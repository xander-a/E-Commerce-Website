...
<html>
    ...
    <body>
        ...
        <div class="card" style="width: 400px; background-color: #212121; margin-top:100px;">
            <div style="color: #96877e;" class="card-header">
                <h3><b>Form</b></h3>
            </div>
            <br>
            <table>
                <form method="post" action="${pageContext.request.contextPath}/products" onsubmit="return formValidation()">
                    <tr>
                        <td><label style="color: #96877e;" for="productID">Product ID:</label></td>
                        <td><input type="text" id="productID" name="productID" placeholder=""
                                    value="<c:out value='${product.productID}'/>" required></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" id="productName" name="productName" placeholder="" 
                                    value="<c:out value='${product.productName}'/>" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="productPrice" name="productPrice" placeholder="" step="0.01"
                                   value="<c:out value='${product.productPrice}'/>" required></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" id="productQuantity" name="productQuantity" placeholder="" 
                                   value="<c:out value='${product.productQuantity}'/>" required></td>
