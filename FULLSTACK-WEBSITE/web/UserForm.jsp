    ...
    <body>
        ...
        <main>    
            ...
            <div class="card" style="width: 400px; background-color: #212121; margin-top:110px;">
                ...
                <br>
                <table>
                    <form id="myForm" method="post" action="${pageContext.request.contextPath}/user/create" onsubmit="return formValidation()">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input style="color: #96877e" type="password" id="password_1" class="form-control" name="password" required></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="address" name="completeAddress" placeholder=""
                                       required></td>
                        </tr>
                        <tr>
                            <td><label style="color: #96877e;" for="birthday">Birthday</label></td>
                            <td><input type="text" id="birthday" name="birthday" placeholder=""
                                       required></td>
                        </tr>
                        <tr>
                            <td><label style="color: #96877e;" for="mobile">Mobile</label></td>
                            <td><input type="text" id="mobile" name="mobileNumber" placeholder=""
                                       required></td>
                        </tr>
                        <tr>
                            <td><label style="color: #96877e;" for="AccountStatus">Account Status:</label></td>
                            <td><input type="text" id="accountStatus" name="accountStatus" placeholder=""
                                       required></td>
                        </tr>
                        <tr>
                            <td><label style="color: #96877e;" for="LoginStatus">Login Status:</label></td>
                            <td><input type="text" id="LoginStatus" name="loginStatus" placeholder=""
                                       required></td>
                        </tr>
                        <tr>
