            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav" >
                    <ul class="navbar-nav ms-auto bg-0a0a0a">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/product" style="color: #96877e;">Products</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="nav-icon navbar-nav ms-auto bg-0a0a0a" >
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/login" class="nav-link" aria-current="page" style="color: #96877e;">User<i class="bi bi-person-circle"></i></a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" aria-current="page" style="color: #96877e;">Search<i class="bi bi-search"></i></a>
                            </li>
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/productPage" class="nav-link" aria-current="page" style="color: #96877e;">Add to Cart<i class="bi bi-cart4"></i></a>
                            </li>   
                        </ul>
                    </div>
                </div>
